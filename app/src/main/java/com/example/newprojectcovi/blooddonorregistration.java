...
public class blooddonorregistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blooddonorregistration);
        ...
        btSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (awesomeValidation.validate()) {
                    ...
                    reference = rootnode.getReference("blooddonors");
                    //get all the values
