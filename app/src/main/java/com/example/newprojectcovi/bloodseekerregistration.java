...
public class bloodseekerregistration extends AppCompatActivity {

    EditText etName, etEmail, etPassword, etAge, etAadhar, etMobile, etbldgrp,  etAddress;
    Button btSubmit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bloodseekerregistration);

        //Variables
        etName = findViewById(R.id.et_name);
        etAddress = findViewById(R.id.et_adress);
        etMobile = findViewById(R.id.et_pass3);
        ...
        //For Mobile Number
        String s1;
        awesomeValidation.addValidation(this, R.id.et_pass3
        ...
        btSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (awesomeValidation.validate()) {
                    ...
                    reference = rootnode.getReference("bloodseekers");
                    //get all the values
                    ...
                    BloodUserHelper helperClass = new BloodUserHelper(name,password,email,address,bldgroup,age,mobile,aadhar);
